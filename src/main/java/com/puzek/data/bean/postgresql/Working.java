...
public class Working {
    ...
    public Working(long id, long parentId, String messageId, int userId, String allocateTime, String allocateCarNumber, String auditCarNumber, String auditTime, String feedbackResult, String feedbackTime, int times) {
        this.id = id;
